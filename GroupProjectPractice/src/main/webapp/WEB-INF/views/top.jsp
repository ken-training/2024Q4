                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/product?product_id=${saleProduct.product_id}">
                                <div class="product_link">
                                    ...
                                    <div>
                                        <p class="product_message"><c:out value="${saleProduct.product_name}" /><br>
                                        	\ <fmt:formatNumber value="${saleProduct.price}" pattern="#,###" /> (税抜)</p>
                                    </div>
                                </div>
                            </a>
                        </td>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/product?product_id=${allProduct.product_id}">
                                <div class="product_link">
                                    ...
                                    <div>
                                        <p class="product_message"><c:out value="${allProduct.product_name}" /><br>
                                        	\ <fmt:formatNumber value="${allProduct.price}" pattern="#,###" /> (税抜)</p>
                                    </div>
                                </div>
                            </a>
                        </td>
